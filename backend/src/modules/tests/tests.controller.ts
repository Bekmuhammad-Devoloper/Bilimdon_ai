...
export class TestsController {
  ...
  @ApiResponse({ status: 201, description: 'Test boshlandi, savollar qaytarildi' })
  ...
  @ApiResponse({ status: 200, description: 'Test yakunlandi, natijalar qaytarildi' })
  async submitTest(
    @Req() req: any,
  ...
  async getTestResult(@Req() req: any, @Param('testAttemptId') testAttemptId: string) {
