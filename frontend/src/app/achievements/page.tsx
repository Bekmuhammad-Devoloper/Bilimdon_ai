...
export default function AchievementsPage() {
  ...
  const totalXPEarned = achievements.unlocked.reduce((sum, a) => sum + a.xpReward, 0);
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500">
            {achievements.unlocked.length}/{achievements.unlocked.length + achievements.locked.length} olingan
          </p>
        </div>
      </div>
      ...
      <section className="mb-8">
        ...
        {achievements.unlocked.length === 0 ? (
          <Card className="text-center py-8">
            ...
            <Link href="/categories" className="mt-4 inline-block text-indigo-600 hover:underline">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge variant="success">+{achievement.xpReward} XP</Badge>
                      <span className="text-xs text-gray-400">
                        {achievement.unlockedAt && new Date(achievement.unlockedAt).toLocaleDateString('uz-UZ')}
                      </span>
                    </div>
                  </div>
                </div>
