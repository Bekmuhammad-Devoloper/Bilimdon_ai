          ...
          {messages.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Dasturlash, matematika, tillar va boshqa fanlar bo'yicha savollar bering
              </p>
                        ...
                        components={{
                          code({ node, className, children, ...props }: any) {
                            ...
                            return !inline && match ? (
                              ...
                              <code className={cn(className, 'bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded')} {...props}>
                                {children}
                              </code>
                            );
                          },
      ...
      <div className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3">
        <div className="container mx-auto max-w-3xl">
          ...
          <p className="text-xs text-gray-400 text-center mt-2">
            AI javoblari har doim to'g'ri bo'lmasligi mumkin. Muhim ma'lumotlarni tekshiring.
          </p>
        </div>
      </div>
    </div>
