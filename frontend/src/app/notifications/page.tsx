            ...
            >
              <div className="flex items-start gap-4">
                ...
                {notification.data?.iconUrl ? (
                  <img 
                    src={getUploadUrl(notification.data.iconUrl) || undefined}
                    alt="Kategoriya"
                  ...
                  <img 
                    src={getUploadUrl(notification.data.adminAvatar) || undefined}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {notification.data?.imageUrl && (
                    <div className="mt-3">
                      <img
                        src={getUploadUrl(notification.data.imageUrl) || undefined}
                        alt="Xabar rasmi"
                        className="rounded-xl max-w-full max-h-64 object-cover cursor-pointer hover:opacity-90 transition"
                        onClick={() => window.open(
                          getUploadUrl(notification.data?.imageUrl) || undefined,
                          '_blank'
                        )}
                      />
                    </div>
                  ...
                  {notification.data?.videoUrl && (
                    <div className="mt-3">
                      {(() => {
                        const videoUrl = getUploadUrl(notification.data?.videoUrl);
                        return (
                          <video
                            controls
                            playsInline
