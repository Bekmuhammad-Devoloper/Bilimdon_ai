...
import { Mail, ArrowLeft, Send, CheckCircle, Lock, Eye, EyeOff, KeyRound, Loader2, RefreshCw } from 'lucide-react';
...
export default function ForgotPasswordPage() {
  ...
  const [step, setStep] = useState<'email' | 'code' | 'success' | 'invite-sent'>('email');
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 text-center shadow-2xl">
            ...
            >
              <p className="text-yellow-300 text-sm">
                💡 <strong>Eslatma:</strong> Parolni tiklash faqat ro'yxatdan o'tgan email uchun ishlaydi
              </p>
            </motion.div>
                ...
                <div className="flex justify-center gap-2 sm:gap-3" onPaste={handlePaste}>
                  {verificationCode.map((digit, index) => (
                    ...
                    >
                      ...
                      <div className={`absolute -bottom-2 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full transition-all duration-300 ${
                        digit ? 'bg-purple-500 scale-100' : 'bg-gray-600 scale-75'
                      }`} />
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-gray-700/50 border-2 rounded-xl py-3 pl-12 pr-12 text-white placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all ${
                      resetForm.formState.errors.newPassword ? 'border-red-500' : 'border-gray-600'
                    }`}
                  />
                  <button
                    type="button"
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full bg-gray-700/50 border-2 rounded-xl py-3 pl-12 pr-12 text-white placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all ${
                      resetForm.formState.errors.confirmPassword ? 'border-red-500' : 'border-gray-600'
                    }`}
                  />
                  <button
                    type="button"
            ...
            >
              {countdown > 0 ? (
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-gray-700/30 rounded-xl">
                  ...
                  <span className="text-gray-400 text-sm">soniya kutib turing</span>
                </div>
              ) : (
                <motion.button
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              Email manzilingizni kiriting va biz sizga parolni tiklash kodini yuboramiz
            </p>
          </div>
          ...
          <form onSubmit={emailForm.handleSubmit(onSubmitEmail)} className="space-y-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-gray-700/50 border rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all ${
                    emailForm.formState.errors.email ? 'border-red-500' : 'border-gray-600'
                  }`}
                />
              </div>
            ...
            >
              ...
              <p className="text-emerald-300 text-xs leading-relaxed">
                <strong>Eslatma:</strong> Faqat saytda <strong>ro'yxatdan o'tgan</strong> email manzilga parolni tiklash kodi yuboriladi. 
                Agar ro'yxatdan o'tmagan bo'lsangiz, taklif havolasi yuboriladi.
              </p>
            </motion.div>
