        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          >
            ...
            <h2 className="text-3xl font-semibold mb-4 leading-tight">
              Bilimingizni sinang va<br />
              <span className="text-yellow-300">yangi cho'qqilarga</span> erishing
            </h2>
            
            <p className="text-white/70 text-lg mb-8 max-w-md">
              30+ kategoriya, minglab savollar va AI yordamchi bilan bilimingizni oshiring
            </p>
        ...
        >
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center gap-2 mb-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Bilimdon</h1>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              {/* Umumiy xato xabari */}
              {errors.emailOrUsername?.message && errors.emailOrUsername.message !== 'Email yoki username kiritilmagan' && (
                <motion.div
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-gray-800 text-gray-500">yoki</span>
              </div>
            </div>
