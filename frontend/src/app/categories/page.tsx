...
const allCategories = [
  ...
  { id: '4', name: 'Ingliz tili', slug: 'ingliz-tili', description: 'Ingliz tili grammatikasi', color: '#DC143C' },
  { id: '5', name: 'Express.js', slug: 'expressjs', description: 'Express.js backend framework', color: '#000000' },
  { id: '6', name: 'Fizika', slug: 'fizika', description: 'Fizika fani asoslari', color: '#4169E1' },
  { id: '7', name: 'Git', slug: 'git', description: 'Git version control', color: '#F05032' },
  { id: '8', name: 'Go', slug: 'golang', description: 'Go dasturlash tili', color: '#00ADD8' },
  { id: '9', name: 'Tarix', slug: 'tarix', description: 'Jahon va O\'zbekiston tarixi', color: '#8B4513' },
  { id: '10', name: 'HTML & CSS', slug: 'html-css', description: 'Web sahifa yaratish asoslari', color: '#E34F26' },
  { id: '11', name: 'Java', slug: 'java', description: 'Java dasturlash tili', color: '#007396' },
  { id: '12', name: 'JavaScript', slug: 'javascript', description: 'JavaScript dasturlash tili', color: '#F7DF1E' },
  { id: '13', name: 'Linux', slug: 'linux', description: 'Linux operatsion tizimi', color: '#FCC624' },
  { id: '14', name: 'Matematika', slug: 'matematika', description: 'Matematika fani', color: '#1E90FF' },
  { id: '15', name: 'MongoDB', slug: 'mongodb', description: 'MongoDB NoSQL database', color: '#47A248' },
  { id: '16', name: 'NestJS', slug: 'nestjs', description: 'NestJS backend framework', color: '#E0234E' },
  { id: '17', name: 'Next.js', slug: 'nextjs', description: 'Next.js React framework', color: '#000000' },
  { id: '18', name: 'Node.js', slug: 'nodejs', description: 'Node.js runtime', color: '#339933' },
  { id: '19', name: 'PostgreSQL', slug: 'postgresql', description: 'PostgreSQL database', color: '#336791' },
  { id: '20', name: 'Python', slug: 'python', description: 'Python dasturlash tili', color: '#3776AB' },
  { id: '21', name: 'React', slug: 'react', description: 'React frontend kutubxonasi', color: '#61DAFB' },
  { id: '22', name: 'Redis', slug: 'redis', description: 'Redis in-memory database', color: '#DC382D' },
  { id: '23', name: 'Rust', slug: 'rust', description: 'Rust dasturlash tili', color: '#000000' },
  { id: '24', name: 'SQL', slug: 'sql', description: 'SQL so\'rovlar tili', color: '#4479A1' },
  { id: '25', name: 'Tailwind CSS', slug: 'tailwind', description: 'Tailwind CSS framework', color: '#06B6D4' },
  { id: '26', name: 'TypeScript', slug: 'typescript', description: 'TypeScript dasturlash tili', color: '#3178C6' },
  { id: '27', name: 'Vue.js', slug: 'vuejs', description: 'Vue.js frontend framework', color: '#4FC08D' },
];
...
export default function CategoriesPage() {
  ...
  const staticGroups = [
    ...
    { id: 'science', name: 'Fanlar', slugs: ['matematika', 'fizika', 'ingliz-tili', 'tarix'] },
  ...
  const customGroupCategories = apiCategories.filter((cat: any) => 
    cat.group && 
    cat.group !== 'other' &&
  ...
  const customGroupIds = [...new Set(customGroupCategories.map((cat: any) => cat.group))];
  
  customGroupIds.forEach((groupId: string) => {
    const groupCategories = customGroupCategories.filter((cat: any) => cat.group === groupId);
              ...
              <Link key={category.id} href={`/test/${category.slug}`}>
                <Card hover className="h-full p-6 group">
                  <div className="flex items-start gap-4">
                    <div className={`rounded-2xl flex items-center justify-center flex-shrink-0 bg-gray-100 dark:bg-gray-800 overflow-hidden ${isUploadedIcon ? 'w-16 h-16' : 'w-14 h-14 p-2'}`}>
                      {iconUrl ? (
                        // eslint-disable-next-line @next/next/no-img-element
                        <img 
                          src={iconUrl} 
                          alt={category.name}
                          className={isUploadedIcon ? "w-full h-full object-cover" : "w-full h-full object-contain"}
                        />
                      ) : (
